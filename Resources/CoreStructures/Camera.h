...
public:
	...
	// Constructor with no cam settings and vectors
	Camera(unsigned int screenWidth, unsigned int screenHeight, double nearPlane, double farPlane, glm::vec3 position);
